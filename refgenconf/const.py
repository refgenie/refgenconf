...
OPERATION_IDS = {
    "asset": [
        API_ID_ARCHIVE, API_ID_ASSET_ATTRS, API_ID_DIGEST, API_ID_RECIPE, API_ID_LOG, API_ID_SPLASH
    ]
}
...
__all__ = ["DEFAULT_SERVER", "CFG_ASSET_DEFAULT_TAG_KEY", "CFG_KEY_NAMES", "CFG_GENOME_DESC_KEY", "REQ_CFG_VERSION",
           ...
           "REQ_TAG_ATTRS", "CUSTOM_BAR_FMT", "API_VERSION", "CONF_STRUCTURE", "OPERATION_IDS"] + FILE_DIR_NAMES + \
          CFG_CONST + CFG_KEY_NAMES + API_IDS
