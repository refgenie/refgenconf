...
CFG_KEY_NAMES = ["CFG_ENV_VARS", "CFG_NAME", "CFG_GENOMES_KEY", "CFG_ASSET_PATH_KEY", "CFG_ARCHIVE_KEY",
                 "CFG_FOLDER_KEY", "CFG_ARCHIVE_SIZE_KEY", "CFG_ASSET_SIZE_KEY", "CFG_CHECKSUM_KEY"]
