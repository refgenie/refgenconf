...
CFG_GENOME_ATTRS_KEYS = [CFG_GENOME_DESC_KEY, CFG_CHECKSUM_KEY, CFG_CONTENTS_KEY]
...
__all__ = CFG_CONST + CFG_KEY_NAMES + ["DEFAULT_SERVER", "CFG_KEY_NAMES", "CFG_GENOME_DESC_KEY", "REQ_CFG_VERSION",
                                       "CFG_ASSETS_KEY", "CFG_GENOME_ATTRS_KEYS"]
